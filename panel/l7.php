...
<html>
		<div class="page-wrapper" style="display: block;">
			...
			<script src="assets/js/modal.js"></script>
				<div class="d-flex align-items-center">
					<h4 class="page-title text-truncate text-white font-weight-medium mb-0">Hub L7</h4>
					<div class="ml-auto">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb m-0 p-0">
								<li class="breadcrumb-item text-sql" aria-current="page"><?php echo $sitename; ?></li>
								<li class="breadcrumb-item text-muted" aria-current="page">Hub L7</li>
							</ol>
						</nav>
					</div>
				</div>
      ...
      <div class="container-fluid">
              ...
              <div class="form-group" id="l7" name="l7" style="display: block;">
                <label for="host" class="col-md-14 text-white">Target</label>
                <div class="col-md-14">
                  <input class="form-control" type="text" id="host" name="host" placeholder="https://example.com/" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Url address of the target">
                </div>
              </div>
			    <div class="form-group" id="postdiv" name="postdiv" style="display: block;">
			    ...
			    <div class="form-group" id="refererdiv" name="refererdiv" style="display: block;">
